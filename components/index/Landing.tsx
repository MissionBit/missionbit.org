...
const useStyles = makeStyles((theme) => ({
  ...
  bridge: {
    ...
    right: 0,
    bottom: 0,
    background: `no-repeat right bottom / contain url(${
      require("public/images/landing/bridge.svg").default.src
    })`,
  },
  ...
  hillStudents: {
    ...
    overflow: "hidden",
    backgroundImage: `url(${
      require("public/images/landing/hill-students.svg").default.src
    })`,
    ...
    <section className={classes.section}>
      ...
      <div className={classes.arrowContainer}>
        <a href="#main" className={classes.arrowWrapper} onClick={smoothScroll}>
          <Image
            src={require("public/images/landing/down-arrow.svg").default}
